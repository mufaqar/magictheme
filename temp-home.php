...
<section class="vm-hero py-5">
        ...
        <div class="container mt-5 pt-4">
            <div class="row vm_artist_gallery align-items-end">
                <div class="col-md-3 work_card">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/work1.png" width="418"
                        height="574">
                    <div>
                ...
                <div class="col-md-9">
                    <h2 class="immortalize-title mb-4">
                        Artist Products
                    </h2>
                    <div class="row">
    ...
    <div class="features-section container">
        <div class="stats_box">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/stats1.png" class="feature-icon"
                alt="">
            <div>
                <h4>Same Day Deliver</h4>
                <p>Get your favorite photos printed and delivered to your doorstep on the very same day. Fast, easy &
